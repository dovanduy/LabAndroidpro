...
import com.dkzy.areaparty.phone.utilseverywhere.tools.IntentBuilder;
    ...
    public static boolean gotoPermissionSetting() {
        ...
        switch (romType) {
            case EMUI: // 华为
                ...
                intent.setComponent(new ComponentName("com.huawei.systemmanager", "com.huawei.permissionmanager.ui.SubTitleUtil"));
                break;
            case Flyme: // 魅族
