...
public class FloatManagerMain {
    ...
    private static FloatManagerMain instance = null;

    public static FloatManagerMain getFloatManager(Context context) {
        if (instance == null) {
            instance = new FloatManagerMain(context);
        }
        return instance;
    }

    private FloatManagerMain(Context context) {
    ...
    private OnClickListener floatViewClick = new OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            View popupView = View.inflate(context, Utils.getLayout(context, "float_main_big"), null);
            /*RelativeLayout centerlayout = (RelativeLayout) popupView.findViewById(Utils.getId(context, "center"));*/
//            RelativeLayout giftlayout = (RelativeLayout) popupView.findViewById(Utils.getId(context, "bluetooth"));
//            RelativeLayout paylayout = (RelativeLayout) popupView.findViewById(Utils.getId(context, "bluemouse"));
            RelativeLayout eventlayout = (RelativeLayout) popupView.findViewById(Utils.getId(context, "main_exit"));
...
//                    popupView.setBackgroundResource(Utils.getDrawable(context, "dropzonebg_left"));
               ...
               /* centerlayout.setOnClickListener(new OnClickListener() {
                ...
                /*giftlayout.setOnClickListener(new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ComputerBluetooth.actionStart(context);
                        FloatManagerMain.getFloatManager(context).destroyFloat();
                        dismisPopupWindow();
                    }
                });*/
                /*paylayout.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View arg0) {
                        BluetoothKeyboard.actionStart(context);
                        FloatManagerMain.getFloatManager(context).destroyFloat();
                        dismisPopupWindow();
