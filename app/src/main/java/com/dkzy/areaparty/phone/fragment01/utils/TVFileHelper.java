...
public class TVFileHelper {
    ...
    public TVFileHelper(Handler myHandler) {
    ...
    public void loadFiles() {
        Log.e("TVFileHelper", "开始加载" + nowFilePath + "下的文件");
        new Thread(){
            @Override
            public void run() {
                datas.clear();
                try {
                    ReceivedFileManagerMessageFormat fileManagerMessage = (ReceivedFileManagerMessageFormat)
                            prepareDataForFragment.getFileActionStateData_tv(OrderConst.folderAction_name,
            ...
            public void run() {
                try {
                    ...
                    if(messageFormat.getStatus() == OrderConst.failure) {
                        Log.e("TVFileHelper", "添加路径到PC服务器出错");
                        String errorFiles = "---";
...
//                            }
    ...
    public void playMedia(final fileBean file ) {
        Log.e("TVFileHelper", "添加选定的文件路径到HTTP服务器" + selectedFiles.size());
        final List<String> filePaths = new ArrayList<>();
        filePaths.add(nowFilePath + file.name);
        new Thread(){
    ...
    public void deleteFileAndFolder() {
        Log.e("TVFileHelper", "开始删除选中的文件(夹)" + (selectedFolders.size() + selectedFiles.size()));
        reCeivedActionErrorMessageList.clear();
        new Thread(){
            @Override
            public void run() {
    ...
    public void deleteFile(final List<String> paths) {
        Log.e("TVFileHelper", "开始删除选中的文件(夹)" + (paths.size()));
        reCeivedActionErrorMessageList.clear();
        new Thread(){
            @Override
            public void run() {
...
//                }
    ...
    public void cutFileAndFolder() {
        Log.e("TVFileHelper", "开始移动选中的文件(夹)到" + nowFilePath);
        reCeivedActionErrorMessageList.clear();
        new Thread(){
            @Override
            public void run() {
    ...
    public void copyFileAndFolder() {
        Log.e("TVFileHelper", "开始复制选中的文件(夹)到" + nowFilePath);
        reCeivedActionErrorMessageList.clear();
        new Thread(){
            @Override
            public void run() {
    ...
    public void copyFile(final List<String> paths, final String targetPath) {
        Log.e("TVFileHelper", "开始复制选中的文件(夹)到" + targetPath);
        reCeivedActionErrorMessageList.clear();
        new Thread(){
            @Override
            public void run() {
...
//
    ...
    public void shareFile(final String des, final SharedfileBean file) {
        Log.e("TVFileHelper", "开始分享文件到服务器" + file.name);
        new Thread(){
            @Override
            public void run() {
    ...
    public static void setNowFilePath(String nowFilePath) {
        TVFileHelper.nowFilePath = nowFilePath;
    }
    ...
    public static void setIsInitial(boolean isInitial) {
        TVFileHelper.isInitial = isInitial;
    }
    ...
    public static void setSourcePath(String sourcePath) {
        TVFileHelper.sourcePath = sourcePath;
    }
    ...
    public static void setReCeivedActionErrorMessageList(List<String> reCeivedActionErrorMessageList) {
        TVFileHelper.reCeivedActionErrorMessageList = reCeivedActionErrorMessageList;
    }
    ...
    public static void setSelectedFiles(List<fileBean> selectedFiles) {
        TVFileHelper.selectedFiles = selectedFiles;
    }
    ...
    public static void setSelectedFolders(List<fileBean> selectedFolders) {
        TVFileHelper.selectedFolders = selectedFolders;
    }
    ...
    public static void setSelectedShareFile(SharedfileBean selectedShareFile) {
        TVFileHelper.selectedShareFile = selectedShareFile;
    }
}
